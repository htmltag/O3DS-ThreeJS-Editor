...
function Viewport( editor ) {
	...
	scene.background = new THREE.Color( '#647882' );
	...
	signals.rendererCreated.add( function ( newRenderer ) {
		...
		if ( window.matchMedia ) {
			...
			mediaQuery.addEventListener( 'change', function ( event ) {
				...
				updateGridColors( grid1, grid2, event.matches ? [ 0xeeeeee, 0x888888 ] : [ 0x888888, 0x282828 ] );
			...
			updateGridColors( grid1, grid2, mediaQuery.matches ? [ 0x222222, 0x888888 ] : [ 0xeeeeee, 0xA1A1A1 ] );
	...
	function render() {
		...
		if(scene.background == null) scene.background = new THREE.Color( '#647882' );
